...
const (
	...
	UpgradeInitialStateAnnotationKeyFmt = "xdxct.com/%s-driver-upgrade.node-initial-state.unschedulable"
	...
	UpgradeWaitForPodCompletionStartTimeAnnotationKeyFmt = "xdxct.com/%s-driver-upgrade-wait-for-pod-completion-start-time"
	...
	UpgradeValidationStartTimeAnnotationKeyFmt = "xdxct.com/%s-driver-upgrade-validation-start-time"
